...
internal class InMemoryKeyVaultSecretsService(InMemoryKeyVault keyVault)
{
    private readonly SecretsDictionary _secrets = new();

    private readonly TimeProvider _timeProvider = keyVault.Provider.TimeProvider;

    public Uri VaultUri => keyVault.VaultUri;
        ...
        )
    {
        ...
        while (true)
        {
            ...
            {
                var newSecret = InMemoryKeyVaultSecret.CreateWithInitialVersion(VaultUri, secretName, inputSecretVersion, _timeProvider);
