...
public abstract class ConsumerPartitionBeforeHookContext(ConsumerPartitionEventHubScope scope, ConsumerOperations operation, InMemoryEventHubProvider provider, CancellationToken cancellationToken)
